      ...
      ru: `
        <section>
          <section>
            ...
            <p>Набирающие популярность группы сталкиваются с проблемой спама. Количество спамеров сейчас насчитывает десятки тысяч и каждый день автоматически регистируются тысячи новых.</p>

            <p>Перед администраторами групп стоит выбор: сделать сообщество приватным или поставить капчу на вход. Оба этих решения приводят к потере участников</p>

            <p>Титус предлагает третий путь — защита от спама в телеграмме без капчи для публичных групп.</p>
          </section>
          ...
          <section>
            ...
            <section>
              ...
              <p>Но у этого способа есть недостаток: спамер может еще не успеть попасть в базы, тогда применяется анализ сообщений:</p>
            </section>

            <section>
              <h4><strong>Текстовый анализ сообщений</strong></h4>

              <p>Если спамер еще не успел попасть в базу, то он не будет забанен на входе, но его сообщения будут анализироваться на соответствие паттернам, присущим спаму.</p>
            ...
            <section>
              ...
              <p>Титус поддерживает еще один сценарий распространения спама, когда спам бот присылает просто изображение без подписи.</p>

              <p>Сейчас эта функция в альфа-режиме: бот постепенно накапливает примеры таких изображений, чтобы в будущем распознавать более точно распознавать спам на картинках. Пока большинство таких сообщений пропускаются, но это временно.</p>
            </section>
          </section>
